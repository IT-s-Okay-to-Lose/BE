...
public enum BaseResponseStatus {
    ...
    // -------- 인증/인가 오류 (1100~1199) -------- //
    UNAUTHORIZED(false, 1100, "인증이 필요합니다."),
    FORBIDDEN(false, 1101, "접근 권한이 없습니다."),
    INVALID_TOKEN(false, 1102, "유효하지 않은 토큰입니다."),
    EXPIRED_TOKEN(false, 1103, "토큰이 만료되었습니다."),

    // -------- 사용자 관련 오류 (2000~2099) -------- //
    NOT_FOUND_MEMBER(false, 2000, "일치하는 사용자가 없습니다."),
    DUPLICATE_USERNAME(false, 2001, "이미 존재하는 사용자 이름입니다."),
    INVALID_LOGIN(false, 2002, "아이디 또는 비밀번호가 올바르지 않습니다."),
    ...
    // -------- 서버 오류 (5000~5999) -------- //
    INTERNAL_SERVER_ERROR(false, 5000, "서버 오류가 발생했습니다."),
    SERVICE_UNAVAILABLE(false, 5001, "일시적으로 서비스를 사용할 수 없습니다.");
